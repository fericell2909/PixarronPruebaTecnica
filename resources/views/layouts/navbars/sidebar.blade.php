<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
      ...
      @role(config('constants.ROL_SUPER_OWNER'))
        @include('layouts.navbars.menus.superowner')
      @else
        <span></span>
      @endrole
      @role(config('constants.ROL_ADMIN'))
        @include('layouts.navbars.menus.admin')
      @else
        <span></span>
      @endrole

      @role(config('constants.ROL_DRIVER'))
        @include('layouts.navbars.menus.driver')
      @else
        <span></span>
      @endrole

      @role(config('constants.ROL_OWNER'))
        @include('layouts.navbars.menus.owner')
      @else
        <span></span>
      @endrole

      @role(config('constants.ROL_CLIENT'))
